    ...
    <style>
        * {
        ...
        .btn-login:hover {
            ...
            box-shadow: 0 8px 20px rgba(23, 85, 132, 0.4);
            background: linear-gradient(135deg, #1b3270, #457B9D);
        }

        .btn-login:active {
            transform: translateY(0);
            box-shadow: 0 4px 10px rgba(39, 23, 132, 0.3);
        }
    ...
    <div class="login-wrapper">
        ...
        <div class="login-illustration">
            <div class="illustration-content">
                <h3>Selamat Datang di <br>Apotek Arshaka</h3>
                <p> Ayo Konsultasi atau Beli Obat dari Apotek Kami </p>
                <div class="features">
